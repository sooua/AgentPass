...
const en: Record<string, string> = {
  ...
  "atok.desc": "Scoped tokens for individual agents. Each is limited to the capabilities, environments and target tags you grant — the root token stays full-power.",
  ...
  "atok.presetHint": "reveal + checkout + list + rotate, no admin — full operational power, but the agent can't mint tokens or approve its own gated reveals.",
  "atok.adminWarn": "admin lets this token manage tokens AND approve its own gated reveals — give it only to a human/operator identity, never to your agent. An agent with admin defeats reveal approval.",
...
const zh: Record<string, string> = {
  ...
  "conn.online": "已连接 daemon",
  "conn.offline": "daemon 未连接 —— 重连中",
  "common.delete": "删除",
  "common.revoke": "吊销",
  "common.cancel": "取消",
  "common.done": "完成",
  ...
  "atok.title": "Agent 令牌",
  "atok.desc": "为单个 agent 分配的分权令牌。每个令牌仅限你授予的能力、环境和目标标签——根令牌仍是全权。",
  "atok.once": "立即复制此令牌——只显示一次：",
  "atok.copy": "复制",
  "atok.name": "Agent 名称",
  "atok.caps": "能力",
  "atok.preset": "推荐的 agent 令牌",
  "atok.presetHint": "reveal + checkout + list + rotate，不含 admin——保留全部操作能力，但 agent 无法创建令牌、也无法批准自己的受审批 reveal。",
  "atok.adminWarn": "admin 让此令牌能管理令牌、并能批准自己的受审批 reveal——只发给人工/运维身份，绝不要给你的 agent。带 admin 的 agent 会架空 reveal 审批。",
  "atok.envs": "环境",
  "atok.tags": "目标标签",
