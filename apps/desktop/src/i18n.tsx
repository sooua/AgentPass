...
const en: Record<string, string> = {
  ...
  "atok.desc": "Scope an agent to specific capabilities, environments and targets. Root stays full-power.",
  "atok.once": "Copy this token now — it is shown only once:",
  "atok.copy": "Copy",
  "atok.name": "Agent name",
  "atok.caps": "Capabilities",
  "atok.preset": "Recommended agent token",
  "atok.presetHint": "Grants reveal, checkout, list and rotate — no admin. Full day-to-day power, but it can't mint tokens or self-approve gated reveals.",
  "atok.adminWarn": "admin can manage tokens and self-approve gated reveals. Give it to a human/operator only, never to an agent — an agent with admin defeats approval.",
...
const zh: Record<string, string> = {
  ...
  "atok.title": "智能体令牌",
  "atok.desc": "限定单个智能体的能力、环境与目标;根令牌仍为全权。",
  "atok.once": "立即复制,此令牌只显示一次:",
  "atok.copy": "复制",
  "atok.name": "智能体名称",
  "atok.caps": "能力",
  "atok.preset": "推荐的智能体令牌",
  "atok.presetHint": "授予暴露、签出、列举、轮换四项操作能力,不含管理(admin)。保留全部日常权限,但无法创建令牌或批准自己的受审批暴露。",
  "atok.adminWarn": "管理(admin)权限可创建令牌、并能批准自己的受审批暴露。只发给人工/运维身份,切勿给智能体——否则审批形同虚设。",
  "atok.envs": "环境",
  "atok.tags": "目标标签",
